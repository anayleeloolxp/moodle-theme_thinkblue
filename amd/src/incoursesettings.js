...
define(['jquery'], function($) {
    ...
    function initInCourseSettings() {
        ...
        if (!frontpage) {
            ...
            var courseSettings = $('#thinkblue-course-settings');
            var activitySettings = $('#thinkblue-activity-settings');
            ...
            courseSettingsDropdownToggle.removeAttr('aria-haspopup').attr('aria-controls', 'thinkblue-course-settings');
            ...
            activitySettingsDropdownToggle.removeAttr('aria-haspopup').attr('aria-controls', 'thinkblue-activity-settings');
