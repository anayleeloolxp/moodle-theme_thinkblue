...
/**
 * Theme Think Blue - Layout file for Image area.
 *
...
$imageareafiles = theme_thinkblue_get_imageareacontent();

// Only proceed if received array is not empty.
if (!empty($imageareafiles)) {
    $templatecontext['imageareafiles'] = $imageareafiles;
    echo $OUTPUT->render_from_template('theme_thinkblue/imagearea', $templatecontext);
}
