...
/**
 * Theme Leeloo LXP - Language pack
 *
...
// ...Background image.
$string['backgroundimage_desc_note'] = '<br/> Please note: This will not override the setting "theme_thinkblue | loginbackgroundimage" which means that the pictures uploaded to the login page background will be displayed anyway.';
// ...Brand colors.
...
$string['additionalresourcessetting_desc'] = 'With this setting you can upload additional resources to the theme. You can reference these resources by using a link. The url will look like this: "/pluginfile.php/1/theme_thinkblue/additionalresources/0/yourfilename.someextention"<br/>
...
// PRIVACY.
$string['privacy:metadata'] = 'The Leeloo LXP theme does not store any personal data about any user.';

$string['browse_header'] = 'Register';
